		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SimpleForm Chart Demo",
									"targetURL": "#comsapchartdemochartdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapchartdemochartdemo-display": {
								"semanticObject": "comsapchartdemochartdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.chartdemo.chartdemo",
									"url": sap.ui.require.toUrl("com/sap/chartdemo/chartdemo")
								}
							}
						}
					}
